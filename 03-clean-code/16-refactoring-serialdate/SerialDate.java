/*
 * ======================================================================== JCommon : a free general
 * purpose class library for the Java(tm) platform
 * ========================================================================
 *
 ...
 * other countries.]
 *
 * --------------- SerialDate.java --------------- (C) Copyright 2001-2006, by Object Refinery
 * Limited.
 *
 ...
 *
 * Changes (from 11-Oct-2001) -------------------------- 11-Oct-2001 : Re-organised the class and
 * moved it to new package com.jrefinery.date (DG); 05-Nov-2001 : Added a getDescription() method,
 * and eliminated NotableDate class (DG); 12-Nov-2001 : IBD requires setDescription() method, now
 * that NotableDate class is gone (DG); Changed getPreviousDayOfWeek(), getFollowingDayOfWeek() and
 * getNearestDayOfWeek() to correct bugs (DG); 05-Dec-2001 : Fixed bug in SpreadsheetDate class
 * (DG); 29-May-2002 : Moved the month constants into a separate interface (MonthConstants) (DG);
 * 27-Aug-2002 : Fixed bug in addMonths() method, thanks to N???levka Petr (DG); 03-Oct-2002 : Fixed
 * errors reported by Checkstyle (DG); 13-Mar-2003 : Implemented Serializable (DG); 29-May-2003 :
 * Fixed bug in addMonths method (DG); 04-Sep-2003 : Implemented Comparable. Updated the isInRange
 * javadocs (DG); 05-Jan-2005 : Fixed bug in addYears() method (1096282) (DG);
 * 
 */
 ...
 * <P>
 * Requirement 1 : match at least what Excel does for dates; Requirement 2 : the date represented by
 * the class is immutable;
 * <P>
 * Why not just use java.util.Date? We will, when it makes sense. At times, java.util.Date can be
 ...
 * <P>
 * You can call getInstance() to get a concrete subclass of SerialDate, without worrying about the
...
public abstract class SerialDate implements Comparable, Serializable, MonthConstants {
  ...
  /**
   * Returns <code>true</code> if the supplied integer code represents a valid day-of-the-week, and
   * <code>false</code> otherwise.
   *
   * @param code the code being checked for validity.
   *
   * @return <code>true</code> if the supplied integer code represents a valid day-of-the-week, and
   *         <code>false</code> otherwise.
   */
   ...
   * <P>
   * This method will return one of the constants JANUARY, FEBRUARY, ..., DECEMBER that corresponds
   * to the string. If the string is not recognised, this method returns -1.
   *
   ...
   * <P>
   * The result is positive if this date is after the 'other' date and negative if it is before the
   * 'other' date.
   *
  ...
  /**
   * Returns <code>true</code> if this {@link SerialDate} is within the specified range (INCLUSIVE).
   * The date order of d1 and d2 is not important.
   *
   ...
   * specifies whether or not the end-points are included). The date order of d1 and d2 is not
   * important.
   *
   * @param d1 a boundary date for the range.
   * @param d2 the other boundary date for the range.
