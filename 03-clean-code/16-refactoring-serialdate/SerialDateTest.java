 ...
 * other countries.]
 *
 * ------------------- SerialDateTest.java ------------------- (C) Copyright 2001-2014, by Object
 * Refinery Limited.
 *
 ...
 *
 * Changes ------- 15-Nov-2001 : Version 1 (DG); 25-Jun-2002 : Removed unnecessary import (DG);
 * 24-Oct-2002 : Fixed errors reported by Checkstyle (DG); 13-Mar-2003 : Added serialization test
 * (DG); 05-Jan-2005 : Added test for bug report 1096282 (DG);
 *
 */
...
public class SerialDateTest extends TestCase {
    ...
    public void testMondayPrecedingFriday9Nov2001() {
        SerialDate mondayBefore =
                SerialDate.getPreviousDayOfWeek(SerialDate.MONDAY, this.nov9Y2001);
    ...
    public void testMondayFollowingFriday9Nov2001() {
        SerialDate mondayAfter =
                SerialDate.getFollowingDayOfWeek(SerialDate.MONDAY, this.nov9Y2001);
    ...
    public void testMondayNearestFriday9Nov2001() {
        SerialDate mondayNearest =
                SerialDate.getNearestDayOfWeek(SerialDate.MONDAY, this.nov9Y2001);
